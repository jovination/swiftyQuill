...
return (
<div className="flex flex-col xl:flex-row items-center justify-center gap-8 md:p-10">
 {features.map((feature, index) => (
<div
key={index}
className="w-[345px] md:w-full xl:w-[345px] h-auto rounded-[30px] p-6 bg-[#0d0d0d]/5 shadow-sm flex flex-col gap-10 justify-between"
>
